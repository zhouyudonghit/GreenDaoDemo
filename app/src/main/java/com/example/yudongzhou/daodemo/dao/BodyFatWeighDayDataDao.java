...
/** 
 * DAO for table "BODY_FAT_WEIGH_DAY_DATA".
*/
public class BodyFatWeighDayDataDao extends AbstractDao<BodyFatWeighDayData, Long> {

    public static final String TABLENAME = "BODY_FAT_WEIGH_DAY_DATA";

    /**
     * Properties of entity BodyFatWeighDayData.<br/>
    ...
    public BodyFatWeighDayDataDao(DaoConfig config) {
        super(config);
    }
    
    public BodyFatWeighDayDataDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BODY_FAT_WEIGH_DAY_DATA\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BODY_FAT_WEIGH_DAY_DATA\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, BodyFatWeighDayData entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, BodyFatWeighDayData entity) {
        stmt.clearBindings();
    ...
    @Override
    public BodyFatWeighDayData readEntity(Cursor cursor, int offset) {
        BodyFatWeighDayData entity = new BodyFatWeighDayData( //
    ...
    @Override
    public void readEntity(Cursor cursor, BodyFatWeighDayData entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(BodyFatWeighDayData entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(BodyFatWeighDayData entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(BodyFatWeighDayData entity) {
