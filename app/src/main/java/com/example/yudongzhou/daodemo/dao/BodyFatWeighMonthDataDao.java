...
/** 
 * DAO for table "BODY_FAT_WEIGH_MONTH_DATA".
*/
public class BodyFatWeighMonthDataDao extends AbstractDao<BodyFatWeighMonthData, Long> {

    public static final String TABLENAME = "BODY_FAT_WEIGH_MONTH_DATA";

    /**
     * Properties of entity BodyFatWeighMonthData.<br/>
    ...
    public BodyFatWeighMonthDataDao(DaoConfig config) {
        super(config);
    }
    
    public BodyFatWeighMonthDataDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BODY_FAT_WEIGH_MONTH_DATA\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BODY_FAT_WEIGH_MONTH_DATA\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, BodyFatWeighMonthData entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, BodyFatWeighMonthData entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getId());
    ...
    @Override
    public BodyFatWeighMonthData readEntity(Cursor cursor, int offset) {
        BodyFatWeighMonthData entity = new BodyFatWeighMonthData( //
    ...
    @Override
    public void readEntity(Cursor cursor, BodyFatWeighMonthData entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(BodyFatWeighMonthData entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(BodyFatWeighMonthData entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(BodyFatWeighMonthData entity) {
