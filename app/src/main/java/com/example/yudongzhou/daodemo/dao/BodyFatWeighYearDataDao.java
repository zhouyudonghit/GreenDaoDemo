...
/** 
 * DAO for table "BODY_FAT_WEIGH_YEAR_DATA".
*/
public class BodyFatWeighYearDataDao extends AbstractDao<BodyFatWeighYearData, Long> {

    public static final String TABLENAME = "BODY_FAT_WEIGH_YEAR_DATA";

    /**
     * Properties of entity BodyFatWeighYearData.<br/>
    ...
    public BodyFatWeighYearDataDao(DaoConfig config) {
        super(config);
    }
    
    public BodyFatWeighYearDataDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BODY_FAT_WEIGH_YEAR_DATA\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BODY_FAT_WEIGH_YEAR_DATA\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, BodyFatWeighYearData entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, BodyFatWeighYearData entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getId());
    ...
    @Override
    public BodyFatWeighYearData readEntity(Cursor cursor, int offset) {
        BodyFatWeighYearData entity = new BodyFatWeighYearData( //
    ...
    @Override
    public void readEntity(Cursor cursor, BodyFatWeighYearData entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(BodyFatWeighYearData entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(BodyFatWeighYearData entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(BodyFatWeighYearData entity) {
