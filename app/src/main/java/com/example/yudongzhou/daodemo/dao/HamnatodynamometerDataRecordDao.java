...
/** 
 * DAO for table "HAMNATODYNAMOMETER_DATA_RECORD".
*/
public class HamnatodynamometerDataRecordDao extends AbstractDao<HamnatodynamometerDataRecord, String> {

    public static final String TABLENAME = "HAMNATODYNAMOMETER_DATA_RECORD";

    /**
     * Properties of entity HamnatodynamometerDataRecord.<br/>
    ...
    public HamnatodynamometerDataRecordDao(DaoConfig config) {
        super(config);
    }
    
    public HamnatodynamometerDataRecordDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"HAMNATODYNAMOMETER_DATA_RECORD\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"HAMNATODYNAMOMETER_DATA_RECORD\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, HamnatodynamometerDataRecord entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, HamnatodynamometerDataRecord entity) {
        stmt.clearBindings();
    ...
    @Override
    public HamnatodynamometerDataRecord readEntity(Cursor cursor, int offset) {
        HamnatodynamometerDataRecord entity = new HamnatodynamometerDataRecord( //
    ...
    @Override
    public void readEntity(Cursor cursor, HamnatodynamometerDataRecord entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(HamnatodynamometerDataRecord entity, long rowId) {
        return entity.getUuid();
    }
    
    @Override
    public String getKey(HamnatodynamometerDataRecord entity) {
        if(entity != null) {
            return entity.getUuid();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(HamnatodynamometerDataRecord entity) {
