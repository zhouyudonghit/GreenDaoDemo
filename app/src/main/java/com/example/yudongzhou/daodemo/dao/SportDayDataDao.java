...
/** 
 * DAO for table "SPORT_DAY_DATA".
*/
public class SportDayDataDao extends AbstractDao<SportDayData, Long> {

    public static final String TABLENAME = "SPORT_DAY_DATA";

    /**
     * Properties of entity SportDayData.<br/>
    ...
    public SportDayDataDao(DaoConfig config) {
        super(config);
    }
    
    public SportDayDataDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SPORT_DAY_DATA\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SPORT_DAY_DATA\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SportDayData entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SportDayData entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getId());
    ...
    @Override
    public SportDayData readEntity(Cursor cursor, int offset) {
        SportDayData entity = new SportDayData( //
    ...
    @Override
    public void readEntity(Cursor cursor, SportDayData entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(SportDayData entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(SportDayData entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(SportDayData entity) {
