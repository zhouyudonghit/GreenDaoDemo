...
/** 
 * DAO for table "SPORT_MONTH_DATA".
*/
public class SportMonthDataDao extends AbstractDao<SportMonthData, Long> {

    public static final String TABLENAME = "SPORT_MONTH_DATA";

    /**
     * Properties of entity SportMonthData.<br/>
    ...
    public SportMonthDataDao(DaoConfig config) {
        super(config);
    }
    
    public SportMonthDataDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SPORT_MONTH_DATA\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SPORT_MONTH_DATA\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SportMonthData entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SportMonthData entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getId());
    ...
    @Override
    public SportMonthData readEntity(Cursor cursor, int offset) {
        SportMonthData entity = new SportMonthData( //
    ...
    @Override
    public void readEntity(Cursor cursor, SportMonthData entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(SportMonthData entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(SportMonthData entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(SportMonthData entity) {
