...
/** 
 * DAO for table "SPORT_WEEK_DATA".
*/
public class SportWeekDataDao extends AbstractDao<SportWeekData, Long> {

    public static final String TABLENAME = "SPORT_WEEK_DATA";

    /**
     * Properties of entity SportWeekData.<br/>
    ...
    public SportWeekDataDao(DaoConfig config) {
        super(config);
    }
    
    public SportWeekDataDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SPORT_WEEK_DATA\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SPORT_WEEK_DATA\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SportWeekData entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SportWeekData entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getId());
    ...
    @Override
    public SportWeekData readEntity(Cursor cursor, int offset) {
        SportWeekData entity = new SportWeekData( //
    ...
    @Override
    public void readEntity(Cursor cursor, SportWeekData entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(SportWeekData entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(SportWeekData entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(SportWeekData entity) {
