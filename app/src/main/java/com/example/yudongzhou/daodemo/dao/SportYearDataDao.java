...
/** 
 * DAO for table "SPORT_YEAR_DATA".
*/
public class SportYearDataDao extends AbstractDao<SportYearData, Long> {

    public static final String TABLENAME = "SPORT_YEAR_DATA";

    /**
     * Properties of entity SportYearData.<br/>
    ...
    public SportYearDataDao(DaoConfig config) {
        super(config);
    }
    
    public SportYearDataDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SPORT_YEAR_DATA\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SPORT_YEAR_DATA\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SportYearData entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SportYearData entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getId());
    ...
    @Override
    public SportYearData readEntity(Cursor cursor, int offset) {
        SportYearData entity = new SportYearData( //
    ...
    @Override
    public void readEntity(Cursor cursor, SportYearData entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(SportYearData entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(SportYearData entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(SportYearData entity) {
