 ...
 */
@Entity
public class BodyFatWeighDataRecord {
    @Id
    private String uuid;
    ...
    @Generated(hash = 149556374)
    public BodyFatWeighDataRecord(String uuid, String deviceId, String modleId,
            String userId, String ownerId, String reportTime, int reportStatus,
    ...
    @Generated(hash = 70756279)
    public BodyFatWeighDataRecord() {
    }
