 ...
 */
@Entity
public class BodyFatWeighDayData {
    ...
    @Generated(hash = 1917450973)
    public BodyFatWeighDayData(Long id, String uuId, String beginTime,
    ...
    @Generated(hash = 184803439)
    public BodyFatWeighDayData() {
    }
