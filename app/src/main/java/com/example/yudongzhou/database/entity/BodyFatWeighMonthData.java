 ...
 */
@Entity
public class BodyFatWeighMonthData {
    ...
    @Generated(hash = 1571499670)
    public BodyFatWeighMonthData(long id, String uuId, String beginTime,
    ...
    @Generated(hash = 2039211259)
    public BodyFatWeighMonthData() {
    }
