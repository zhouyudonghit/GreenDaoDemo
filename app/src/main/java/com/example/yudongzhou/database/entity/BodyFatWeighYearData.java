 ...
 */
@Entity
public class BodyFatWeighYearData {
    ...
    @Generated(hash = 1000470027)
    public BodyFatWeighYearData(long id, String uuId, String beginTime,
    ...
    @Generated(hash = 68456486)
    public BodyFatWeighYearData() {
    }
