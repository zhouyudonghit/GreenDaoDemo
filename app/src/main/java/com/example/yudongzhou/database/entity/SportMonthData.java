...
public class SportMonthData {
    ...
    @Generated(hash = 689009965)
    public SportMonthData(long id, String uuId, String beginTime, String endTime,
    ...
    @Generated(hash = 1077241026)
    public SportMonthData() {
    }
