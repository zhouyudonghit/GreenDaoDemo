...
public class SportYearData {
    ...
    @Generated(hash = 1322232916)
    public SportYearData(long id, String uuId, String beginTime, String endTime,
    ...
    @Generated(hash = 1880658596)
    public SportYearData() {
    }
